...
from learning_channels import constants, serializers
...
class ChannelTypeChoiceFieldExtension(OpenApiSerializerFieldExtension):
    target_class = "learning_channels.serializers.ChannelTypeChoiceField"
    priority = 100
...
class ChannelTypeConstantFieldExtension(OpenApiSerializerFieldExtension):
    target_class = "learning_channels.serializers.ChannelTypeConstantField"
    priority = 100
...
class ChannelSerializerExtension(OpenApiSerializerExtension):
    target_class = "learning_channels.serializers.ChannelSerializer"
