...
from learning_channels.api import create_channel_groups_and_roles
from learning_channels.constants import ChannelType
from learning_channels.models import (
    Channel,
...
class ChannelFactory(DjangoModelFactory):
    ...
    topic_detail = factory.Maybe(
        ...
        yes_declaration=factory.RelatedFactory(
            "learning_channels.factories.ChannelTopicDetailFactory",
    ...
    department_detail = factory.Maybe(
        ...
        yes_declaration=factory.RelatedFactory(
            "learning_channels.factories.ChannelDepartmentDetailFactory",
            factory_related_name="channel",
        ),
    )
    ...
    unit_detail = factory.Maybe(
        "create_unit_detail",
        yes_declaration=factory.RelatedFactory(
            "learning_channels.factories.ChannelUnitDetailFactory",
            factory_related_name="channel",
        ),
    )
    ...
    pathway_detail = factory.Maybe(
        ...
        yes_declaration=factory.RelatedFactory(
            "learning_channels.factories.ChannelPathwayDetailFactory",
            factory_related_name="channel",
        ),
    )
