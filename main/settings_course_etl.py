...
OCW_OFFLINE_DELIVERY = get_bool("OCW_OFFLINE_DELIVERY", default=False)
...
MIT_CLIMATE_BASE_URL = "https://climate.mit.edu"
MIT_CLIMATE_EXPLAINERS_API_URL = f"{MIT_CLIMATE_BASE_URL}/feeds/explainers"
ASK_MIT_CLIMATE_API_URL = f"{MIT_CLIMATE_BASE_URL}/feeds/ask-mit-climate"
...
# Authenticated courses endpoint which includes b2b/variant courses
MITX_ONLINE_INTERNAL_COURSES_API_URL = get_string(
    "MITX_ONLINE_INTERNAL_COURSES_API_URL", None
)
...
MITXONLINE_B2B_CLIENT_CONFIG = {
    ...
    "KEYCLOAK_CLIENT_SECRET": get_string("MITXONLINE_B2B_KEYCLOAK_CLIENT_SECRET", ""),
    "KEYCLOAK_REALM_NAME": get_string("MITXONLINE_B2B_KEYCLOAK_REALM_NAME", "olapps"),
    "KEYCLOAK_CLIENT_SCOPES": get_string(
