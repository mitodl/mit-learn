...
# Max index subtasks dispatched as one chord during a reindex; batches run
# sequentially so a catalog-wide reindex cannot saturate the Celery broker
OPENSEARCH_REINDEX_BATCH_SIZE = get_int("OPENSEARCH_REINDEX_BATCH_SIZE", 100)
