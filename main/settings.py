...
# Seconds to suppress duplicate "missing ContentFile" alerts for the same id
CONTENT_FILE_MISSING_LOG_THROTTLE_SECONDS = get_int(
    "CONTENT_FILE_MISSING_LOG_THROTTLE_SECONDS", 3600
)
