...
MITX_ONLINE_REFINE_OIDC_CONFIG_REDIRECT_URI=http://mitxonline.odl.local:8065/staff-dashboard/oauth2/login/
MITX_ONLINE_REFINE_MITX_ONLINE_DATASOURCE=http://mitxonline.odl.local:8065/api
