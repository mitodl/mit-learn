...
OCW_CONTENT_CATEGORIES = [
    ...
    OCW_CONTENT_CATEGORY_READINGS,
    OCW_CONTENT_CATEGORY_PRACTICE,
    OCW_CONTENT_CATEGORY_OPEN_TEXTBOOKS,
    OCW_CONTENT_CATEGORY_LECTURE_AUDIO,
    OCW_CONTENT_CATEGORY_VIDEOS,
]

VALID_COURSE_CONTENT_CATEGORY_CHOICES = list(
    zip(
        OCW_CONTENT_CATEGORIES,
        OCW_CONTENT_CATEGORIES,
    )
...
OCW_COURSE_CONTENT_CATEGORY_MAPPING = {
    ...
    "Problem Sets Solutions": OCW_CONTENT_CATEGORY_PRACTICE,
