...
const TRANSLATIONS: Record<string, Record<TranslationKey, string>> = {
  ...
  de: {
    ...
    forThisProgram: "fur dieses Programm.",
    completed: "Abgeschlossen",
    of: "von",
    courses: "Kursen",
    coreCourses: "Pflichtkurse",
    electiveCourses: "Wahlkurse",
    electivesComplete: "Wahlkurse (Abschliesen Sie {count})",
    addCertificateFor: "Zertifikat fur {price} hinzufugen",
  ...
  es: {
    ...
    emailSettings: "Configuracion de correo",
    ...
    lessThanDayRemaining: "Menos de un dia restante",
    startsToday: "Comienza hoy",
    startsTomorrow: "Comienza manana",
    startsInDays: "Comienza en {days} dias",
  },
  fr: {
    ...
    viewProgramDetails: "Voir les details du programme",
    viewCourseDetails: "Voir les details du cours",
    emailSettings: "Parametres e-mail",
    unenroll: "Se desinscrire",
    startNoun: "Commencer {noun}",
    viewNoun: "Voir {noun}",
    continue: "Continuer",
    youHaveCompleted: "Vous avez complete",
  ...
  pt: {
    ...
    emailSettings: "Configuracoes de e-mail",
    unenroll: "Cancelar inscricao",
    startNoun: "Iniciar {noun}",
    viewNoun: "Ver {noun}",
    continue: "Continuar",
    youHaveCompleted: "Voce concluiu",
    forThisProgram: "para este programa.",
    completed: "Concluido",
    of: "de",
    courses: "cursos",
    coreCourses: "Cursos obrigatorios",
    ...
    startsToday: "Comeca hoje",
    startsTomorrow: "Comeca amanha",
    startsInDays: "Comeca em {days} dias",
  },
  ja: {
