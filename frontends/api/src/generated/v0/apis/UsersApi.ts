...
import type { PatchedUserRequest, User, UserRequest } from "../models/index"
import {
...
export class UsersApi extends runtime.BaseAPI {
  ...
  async usersDestroyRaw(
    ...
    if (requestParameters["username"] == null) {
      throw new runtime.RequiredError(
        "username",
        'Required parameter "username" was null or undefined when calling usersDestroy().',
      )
    }
    ...
    let urlPath = `/api/v0/users/{username}/`
  ...
  async usersRetrieveRaw(
    ...
    if (requestParameters["username"] == null) {
      throw new runtime.RequiredError(
        "username",
        'Required parameter "username" was null or undefined when calling usersRetrieve().',
      )
    }
