...
import type { LearningResourcesVectorSearchResponse } from "../models/index"
import {
...
export class VectorLearningResourcesSearchApi extends runtime.BaseAPI {
   ...
   * Vector Search
   */
  async vectorLearningResourcesSearchRetrieveRaw(
    requestParameters: VectorLearningResourcesSearchRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<LearningResourcesVectorSearchResponse>> {
    ...
    let urlPath = `/api/v0/vector_learning_resources_search/`
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      LearningResourcesVectorSearchResponseFromJSON(jsonValue),
    )
  }
  ...
  async vectorLearningResourcesSearchRetrieve(
    requestParameters: VectorLearningResourcesSearchRetrieveRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<LearningResourcesVectorSearchResponse> {
    const response = await this.vectorLearningResourcesSearchRetrieveRaw(
      requestParameters,
      initOverrides,
    )
