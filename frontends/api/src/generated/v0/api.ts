...
export const VectorLearningResourcesSearchApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {number} [score_cutoff] The minimum dense cosine similarity score a result must have to be returned. Defaults to 0.0 when omitted, but the server clamps the effective cutoff to the minimum allowed for the selected search mode.
...
export interface VectorLearningResourcesSearchApiVectorLearningResourcesSearchRetrieveRequest {
  ...
  /**
   * The minimum dense cosine similarity score a result must have to be returned. Defaults to 0.0 when omitted, but the server clamps the effective cutoff to the minimum allowed for the selected search mode.
   * @type {number}
   * @memberof VectorLearningResourcesSearchApiVectorLearningResourcesSearchRetrieve
   */
