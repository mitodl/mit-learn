...
export const VectorLearningResourcesSearchApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {number} [score_cutoff] The minimum dense cosine similarity score a result must have to be returned, in both dense and hybrid search. Defaults to 0.0 when omitted, but the server clamps the effective cutoff to a configured minimum.
...
export interface VectorLearningResourcesSearchApiVectorLearningResourcesSearchRetrieveRequest {
  ...
  /**
   * The minimum dense cosine similarity score a result must have to be returned, in both dense and hybrid search. Defaults to 0.0 when omitted, but the server clamps the effective cutoff to a configured minimum.
   * @type {number}
   * @memberof VectorLearningResourcesSearchApiVectorLearningResourcesSearchRetrieve
   */
