...
export class LearningResourceDisplayInfoApi extends runtime.BaseAPI {
  ...
  > {
    ...
    let urlPath = `/api/v1/learning_resource_display_info/`
  ...
  async learningResourceDisplayInfoRetrieveRaw(
    ...
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling learningResourceDisplayInfoRetrieve().',
      )
    }
    ...
    let urlPath = `/api/v1/learning_resource_display_info/{id}/`
