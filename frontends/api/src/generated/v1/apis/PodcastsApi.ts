...
export class PodcastsApi extends runtime.BaseAPI {
   ...
   */
  async podcastsItemsListRaw(
    requestParameters: PodcastsItemsListRequest,
    ...
    if (requestParameters["learning_resource_id"] == null) {
      throw new runtime.RequiredError(
        ...
        'Required parameter "learning_resource_id" was null or undefined when calling podcastsItemsList().',
      )
    }
    ...
    let urlPath = `/api/v1/podcasts/{learning_resource_id}/items/`
  ...
  async podcastsItemsList(
    ...
    const response = await this.podcastsItemsListRaw(
      requestParameters,
      initOverrides,
    )
   ...
   */
  async podcastsItemsRetrieveRaw(
    requestParameters: PodcastsItemsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<LearningResourceRelationship>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling podcastsItemsRetrieve().',
      )
    }
    ...
    if (requestParameters["learning_resource_id"] == null) {
      throw new runtime.RequiredError(
        "learning_resource_id",
        'Required parameter "learning_resource_id" was null or undefined when calling podcastsItemsRetrieve().',
      )
    }
    ...
    let urlPath = `/api/v1/podcasts/{learning_resource_id}/items/{id}/`
    urlPath = urlPath.replace(
      `{${"id"}}`,
  ...
  async podcastsItemsRetrieve(
    ...
    const response = await this.podcastsItemsRetrieveRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   * List
   */
  async podcastsListRaw(
    requestParameters: PodcastsListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PaginatedPodcastResourceList>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PaginatedPodcastResourceListFromJSON(jsonValue),
    )
  }
  ...
  async podcastsList(
    requestParameters: PodcastsListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PaginatedPodcastResourceList> {
    const response = await this.podcastsListRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   * Retrieve
   */
  async podcastsRetrieveRaw(
    requestParameters: PodcastsRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PodcastResource>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling podcastsRetrieve().',
      )
    }
    ...
    let urlPath = `/api/v1/podcasts/{id}/`
    urlPath = urlPath.replace(
      `{${"id"}}`,
      encodeURIComponent(String(requestParameters["id"])),
    )
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PodcastResourceFromJSON(jsonValue),
    )
  }
  ...
  async podcastsRetrieve(
    ...
    const response = await this.podcastsRetrieveRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
