...
export class LearningResourcesUserSubscriptionApi extends runtime.BaseAPI {
  ...
  async learningResourcesUserSubscriptionCheckListRaw(
    ...
    if (requestParameters["aggregations"] != null) {
    ...
    if (requestParameters["content_file_score_weight"] != null) {
    ...
    if (requestParameters["dev_mode"] != null) {
    ...
    if (requestParameters["search_mode"] != null) {
      queryParameters["search_mode"] = requestParameters["search_mode"]
    }

    if (requestParameters["slop"] != null) {
    ...
    if (requestParameters["source_type"] != null) {
    ...
    if (requestParameters["yearly_decay_percent"] != null) {
    ...
    let urlPath = `/api/v1/learning_resources_user_subscription/check/`
  ...
  async learningResourcesUserSubscriptionListRaw(
    ...
    let urlPath = `/api/v1/learning_resources_user_subscription/`
  ...
  async learningResourcesUserSubscriptionSubscribeCreateRaw(
    ...
    let urlPath = `/api/v1/learning_resources_user_subscription/subscribe/`
  ...
  async learningResourcesUserSubscriptionUnsubscribeDestroyRaw(
    ...
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling learningResourcesUserSubscriptionUnsubscribeDestroy().',
      )
    }
    ...
    let urlPath = `/api/v1/learning_resources_user_subscription/{id}/unsubscribe/`
