...
export class CoursesApi extends runtime.BaseAPI {
  ...
  async coursesContentfilesListRaw(
    ...
    if (requestParameters["learning_resource_id"] == null) {
      throw new runtime.RequiredError(
        ...
        'Required parameter "learning_resource_id" was null or undefined when calling coursesContentfilesList().',
      )
    }
    ...
    let urlPath = `/api/v1/courses/{learning_resource_id}/contentfiles/`
  ...
  async coursesContentfilesRetrieveRaw(
    ...
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling coursesContentfilesRetrieve().',
      )
    }
    ...
    if (requestParameters["learning_resource_id"] == null) {
      throw new runtime.RequiredError(
        "learning_resource_id",
        'Required parameter "learning_resource_id" was null or undefined when calling coursesContentfilesRetrieve().',
      )
    }
    ...
    let urlPath = `/api/v1/courses/{learning_resource_id}/contentfiles/{id}/`
    urlPath = urlPath.replace(
      `{${"id"}}`,
  ...
  async coursesRetrieveRaw(
    ...
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling coursesRetrieve().',
      )
    }
