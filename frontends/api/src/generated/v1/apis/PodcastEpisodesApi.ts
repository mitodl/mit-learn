...
export class PodcastEpisodesApi extends runtime.BaseAPI {
  ...
  async podcastEpisodesListRaw(
    ...
    let urlPath = `/api/v1/podcast_episodes/`
  ...
  async podcastEpisodesRetrieveRaw(
    ...
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
        'Required parameter "id" was null or undefined when calling podcastEpisodesRetrieve().',
      )
    }
    ...
    let urlPath = `/api/v1/podcast_episodes/{id}/`
