...
export type CompanySizeEnum =
  (typeof CompanySizeEnum)[keyof typeof CompanySizeEnum]
...
export type EnrollmentModeEnum =
  (typeof EnrollmentModeEnum)[keyof typeof EnrollmentModeEnum]
 ...
 * @export
 */
export type PagesRetrieve200Response =
  | CertificatePage
  | CoursePageItem
  | Page
  | ProgramPageItem
...
export type V1ProgramRequirementDataNodeTypeEnum =
  (typeof V1ProgramRequirementDataNodeTypeEnum)[keyof typeof V1ProgramRequirementDataNodeTypeEnum]
...
export type V2ProgramRequirementDataNodeTypeEnum =
  (typeof V2ProgramRequirementDataNodeTypeEnum)[keyof typeof V2ProgramRequirementDataNodeTypeEnum]
...
export type YearsExperienceEnum =
  (typeof YearsExperienceEnum)[keyof typeof YearsExperienceEnum]
...
export const ApiApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    apiRecordsProgramRevokeCreate: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("apiRecordsProgramRevokeCreate", "id", id)
      const localVarPath = `/api/records/program/{id}/revoke/`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    apiRecordsProgramShareCreate: async (
      id: number,
      ...
      const localVarPath = `/api/records/program/{id}/share/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    learnerRecordRetrieveById: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("learnerRecordRetrieveById", "id", id)
      const localVarPath = `/api/records/program/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    learnerRecordRetrieveByUuid: async (
      uuid: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'uuid' is not null or undefined
      assertParamExists("learnerRecordRetrieveByUuid", "uuid", uuid)
      const localVarPath = `/api/records/shared/{uuid}/`.replace(
        `{${"uuid"}}`,
...
export const ApiApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiRecordsProgramRevokeCreate(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<LearnerRecord>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiRecordsProgramRevokeCreate(
          id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ApiApi.apiRecordsProgramRevokeCreate"]?.[
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiRecordsProgramShareCreate(
          id,
          PartnerSchoolRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ApiApi.apiRecordsProgramShareCreate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.learnerRecordRetrieveById(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ApiApi.learnerRecordRetrieveById"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async learnerRecordRetrieveByUuid(
      uuid: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<LearnerRecord>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.learnerRecordRetrieveByUuid(
          uuid,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ApiApi.learnerRecordRetrieveByUuid"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const ApiApiFactory = function (
  ...
  return {
    ...
    apiRecordsProgramRevokeCreate(
      requestParameters: ApiApiApiRecordsProgramRevokeCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<LearnerRecord> {
      return localVarFp
        .apiRecordsProgramRevokeCreate(requestParameters.id, options)
     ...
     */
    apiRecordsProgramShareCreate(
      requestParameters: ApiApiApiRecordsProgramShareCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<LearnerRecord> {
      return localVarFp
        .apiRecordsProgramShareCreate(
          requestParameters.id,
          requestParameters.PartnerSchoolRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
    ...
    learnerRecordRetrieveById(
      requestParameters: ApiApiLearnerRecordRetrieveByIdRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<LearnerRecord> {
      return localVarFp
        .learnerRecordRetrieveById(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get learner record using share UUID
    ...
    learnerRecordRetrieveByUuid(
      ...
      return localVarFp
        .learnerRecordRetrieveByUuid(requestParameters.uuid, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ApiApi extends BaseAPI {
   ...
   * @memberof ApiApi
   */
  public apiRecordsProgramRevokeCreate(
    requestParameters: ApiApiApiRecordsProgramRevokeCreateRequest,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ApiApi
   */
  public apiRecordsProgramShareCreate(
    requestParameters: ApiApiApiRecordsProgramShareCreateRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ApiApiFp(this.configuration)
   ...
   * @memberof ApiApi
   */
  public learnerRecordRetrieveById(
    requestParameters: ApiApiLearnerRecordRetrieveByIdRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ApiApiFp(this.configuration)
   ...
   * @memberof ApiApi
   */
  public learnerRecordRetrieveByUuid(
    requestParameters: ApiApiLearnerRecordRetrieveByUuidRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ApiApiFp(this.configuration)
...
export const B2bApiAxiosParamCreator = function (
  ...
  return {
    ...
    b2bAttachCreate: async (
      ...
      const localVarPath = `/api/v0/b2b/attach/{enrollment_code}/`.replace(
        `{${"enrollment_code"}}`,
        encodeURIComponent(String(enrollment_code)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
    ...
    b2bContractsRetrieve: async (
      ...
      const localVarPath = `/api/v0/b2b/contracts/{contract_slug}/`.replace(
        `{${"contract_slug"}}`,
        encodeURIComponent(String(contract_slug)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
    ...
    b2bOrganizationsRetrieve: async (
      ...
      const localVarPath =
        `/api/v0/b2b/organizations/{organization_slug}/`.replace(
          `{${"organization_slug"}}`,
          encodeURIComponent(String(organization_slug)),
        )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
  ...
  return {
    ...
    async b2bAttachCreate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ContractPage>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.b2bAttachCreate(
        enrollment_code,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["B2bApi.b2bAttachCreate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.b2bContractsList(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["B2bApi.b2bContractsList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async b2bContractsRetrieve(
      contract_slug: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContractPage>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.b2bContractsRetrieve(
          contract_slug,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["B2bApi.b2bContractsRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async b2bEnrollCreate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateB2BEnrollment>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.b2bEnrollCreate(
        readable_id,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["B2bApi.b2bEnrollCreate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async b2bOrganizationsList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<OrganizationPage>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.b2bOrganizationsList(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["B2bApi.b2bOrganizationsList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async b2bOrganizationsRetrieve(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<OrganizationPage>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.b2bOrganizationsRetrieve(
          organization_slug,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["B2bApi.b2bOrganizationsRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const B2bApiFactory = function (
  ...
  return {
     ...
     */
    b2bAttachCreate(
      requestParameters: B2bApiB2bAttachCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<Array<ContractPage>> {
      return localVarFp
        .b2bAttachCreate(requestParameters.enrollment_code, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Viewset for the ContractPage model.
    ...
    b2bContractsRetrieve(
      requestParameters: B2bApiB2bContractsRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ContractPage> {
      return localVarFp
        .b2bContractsRetrieve(requestParameters.contract_slug, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Create an enrollment for the given course run.
     ...
     */
    b2bEnrollCreate(
      requestParameters: B2bApiB2bEnrollCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CreateB2BEnrollment> {
      return localVarFp
        .b2bEnrollCreate(requestParameters.readable_id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Viewset for the OrganizationPage model.
    ...
    b2bOrganizationsRetrieve(
      ...
      return localVarFp
        .b2bOrganizationsRetrieve(requestParameters.organization_slug, options)
        .then((request) => request(axios, basePath))
    },
  }
}
 ...
 * @export
 */
export const ChangeEmailsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    changeEmailsPartialUpdate: async (
      code: string,
      ...
      const localVarPath = `/api/v0/change-emails/{code}/`.replace(
        `{${"code"}}`,
...
export const ChangeEmailsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ChangeEmailsApiAxiosParamCreator(configuration)
  return {
    /**
     * Viewset for creating and updating email change requests
     * @param {ChangeEmailRequestCreateRequest} ChangeEmailRequestCreateRequest
    ...
    async changeEmailsCreate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ChangeEmailRequestCreate>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.changeEmailsCreate(
          ChangeEmailRequestCreateRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ChangeEmailsApi.changeEmailsCreate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async changeEmailsPartialUpdate(
      code: string,
      PatchedChangeEmailRequestUpdateRequest?: PatchedChangeEmailRequestUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ChangeEmailRequestUpdate>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.changeEmailsPartialUpdate(
          code,
          PatchedChangeEmailRequestUpdateRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ChangeEmailsApi.changeEmailsPartialUpdate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.changeEmailsUpdate(
          code,
          ChangeEmailRequestUpdateRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ChangeEmailsApi.changeEmailsUpdate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const ChangeEmailsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     */
    changeEmailsCreate(
      requestParameters: ChangeEmailsApiChangeEmailsCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ChangeEmailRequestCreate> {
      return localVarFp
        .changeEmailsCreate(
          requestParameters.ChangeEmailRequestCreateRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
    ...
    changeEmailsPartialUpdate(
      requestParameters: ChangeEmailsApiChangeEmailsPartialUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ChangeEmailRequestUpdate> {
      return localVarFp
        .changeEmailsPartialUpdate(
          requestParameters.code,
          requestParameters.PatchedChangeEmailRequestUpdateRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
     ...
     */
    changeEmailsUpdate(
      requestParameters: ChangeEmailsApiChangeEmailsUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ChangeEmailRequestUpdate> {
      return localVarFp
        .changeEmailsUpdate(
          requestParameters.code,
          requestParameters.ChangeEmailRequestUpdateRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
...
export class ChangeEmailsApi extends BaseAPI {
   ...
   */
  public changeEmailsCreate(
    requestParameters: ChangeEmailsApiChangeEmailsCreateRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ChangeEmailsApiFp(this.configuration)
      .changeEmailsCreate(
        requestParameters.ChangeEmailRequestCreateRequest,
        options,
      )
   ...
   * @memberof ChangeEmailsApi
   */
  public changeEmailsPartialUpdate(
    requestParameters: ChangeEmailsApiChangeEmailsPartialUpdateRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ChangeEmailsApiFp(this.configuration)
...
export const CountriesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.countriesList(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["CountriesApi.countriesList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const CourseCertificatesApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    courseCertificatesRetrieve: async (
      cert_uuid: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/course_certificates/{cert_uuid}/`.replace(
        `{${"cert_uuid"}}`,
        encodeURIComponent(String(cert_uuid)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
 ...
 * @export
 */
export const CourseCertificatesApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    CourseCertificatesApiAxiosParamCreator(configuration)
  return {
    /**
     * Get a course certificate by UUID.
     * @param {string} cert_uuid
     ...
     * @throws {RequiredError}
     */
    async courseCertificatesRetrieve(
      cert_uuid: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<V2CourseRunCertificate>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.courseCertificatesRetrieve(
          cert_uuid,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          "CourseCertificatesApi.courseCertificatesRetrieve"
 ...
 * @export
 */
export const CourseCertificatesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    courseCertificatesRetrieve(
      requestParameters: CourseCertificatesApiCourseCertificatesRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V2CourseRunCertificate> {
      return localVarFp
        .courseCertificatesRetrieve(requestParameters.cert_uuid, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class CourseCertificatesApi extends BaseAPI {
   ...
   */
  public courseCertificatesRetrieve(
    requestParameters: CourseCertificatesApiCourseCertificatesRetrieveRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return CourseCertificatesApiFp(this.configuration)
      .courseCertificatesRetrieve(requestParameters.cert_uuid, options)
      .then((request) => request(this.axios, this.basePath))
  }
}
 ...
 * @export
 */
export const CourseRunsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    courseRunsRetrieve: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("courseRunsRetrieve", "id", id)
      const localVarPath = `/api/v1/course_runs/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const CourseRunsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    CourseRunsApiAxiosParamCreator(configuration)
  return {
    /**
     * API view set for CourseRuns
     * @param {number} [id]
    ...
    async courseRunsList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<V1CourseRunWithCourse>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.courseRunsList(
        id,
        live,
        options,
      )
    ...
    async courseRunsRetrieve(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<V1CourseRunWithCourse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.courseRunsRetrieve(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
 ...
 * @export
 */
export const CourseRunsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     */
    courseRunsList(
      requestParameters: CourseRunsApiCourseRunsListRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<Array<V1CourseRunWithCourse>> {
      return localVarFp
        .courseRunsList(requestParameters.id, requestParameters.live, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * API view set for CourseRuns
     ...
     */
    courseRunsRetrieve(
      requestParameters: CourseRunsApiCourseRunsRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V1CourseRunWithCourse> {
      return localVarFp
        .courseRunsRetrieve(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class CourseRunsApi extends BaseAPI {
  ...
  public courseRunsList(
    ...
    return CourseRunsApiFp(this.configuration)
      .courseRunsList(requestParameters.id, requestParameters.live, options)
      .then((request) => request(this.axios, this.basePath))
  }
...
export const CoursesApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1CoursesList: async (
      courserun_is_enrollable?: boolean,
      id?: number,
      live?: boolean,
      page?: number,
      page__live?: boolean,
      ...
      if (courserun_is_enrollable !== undefined) {
        localVarQueryParameter["courserun_is_enrollable"] =
     ...
     * @throws {RequiredError}
     */
    apiV2CoursesList: async (
      courserun_is_enrollable?: boolean,
      id?: Array<number>,
      include_approved_financial_aid?: boolean,
      live?: boolean,
      org_id?: number,
      page?: number,
      page__live?: boolean,
      ...
      if (include_approved_financial_aid !== undefined) {
        localVarQueryParameter["include_approved_financial_aid"] =
     ...
     * @throws {RequiredError}
     */
    apiV2CoursesRetrieve: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("apiV2CoursesRetrieve", "id", id)
      const localVarPath = `/api/v2/courses/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async apiV1CoursesList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedV1CourseWithCourseRunsList>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1CoursesList(
          courserun_is_enrollable,
          id,
          live,
          page,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["CoursesApi.apiV1CoursesList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async apiV1CoursesRetrieve(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<V1CourseWithCourseRuns>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1CoursesRetrieve(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["CoursesApi.apiV1CoursesRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async apiV2CoursesList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedCourseWithCourseRunsSerializerV2List>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV2CoursesList(
          courserun_is_enrollable,
          id,
          include_approved_financial_aid,
          live,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["CoursesApi.apiV2CoursesList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async apiV2CoursesRetrieve(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CourseWithCourseRunsSerializerV2>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV2CoursesRetrieve(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["CoursesApi.apiV2CoursesRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const CoursesApiFactory = function (
  ...
  return {
     ...
     */
    apiV1CoursesList(
      requestParameters: CoursesApiApiV1CoursesListRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedV1CourseWithCourseRunsList> {
      return localVarFp
        .apiV1CoursesList(
          requestParameters.courserun_is_enrollable,
          requestParameters.id,
          requestParameters.live,
          requestParameters.page,
          requestParameters.page__live,
    ...
    apiV1CoursesRetrieve(
      requestParameters: CoursesApiApiV1CoursesRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V1CourseWithCourseRuns> {
      return localVarFp
        .apiV1CoursesRetrieve(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * List all courses - API v2
     ...
     */
    apiV2CoursesList(
      requestParameters: CoursesApiApiV2CoursesListRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedCourseWithCourseRunsSerializerV2List> {
      return localVarFp
        .apiV2CoursesList(
          requestParameters.courserun_is_enrollable,
          requestParameters.id,
          requestParameters.include_approved_financial_aid,
          requestParameters.live,
          requestParameters.org_id,
          requestParameters.page,
          requestParameters.page__live,
          requestParameters.page_size,
          requestParameters.readable_id,
    ...
    apiV2CoursesRetrieve(
      requestParameters: CoursesApiApiV2CoursesRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CourseWithCourseRunsSerializerV2> {
      return localVarFp
        .apiV2CoursesRetrieve(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export const DepartmentsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    departmentsRetrieveV2: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("departmentsRetrieveV2", "id", id)
      const localVarPath = `/api/v2/departments/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DepartmentsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async departmentsListV1(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<DepartmentWithCount>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.departmentsListV1(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["DepartmentsApi.departmentsListV1"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async departmentsListV2(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<DepartmentWithCoursesAndPrograms>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.departmentsListV2(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["DepartmentsApi.departmentsListV2"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async departmentsRetrieveV1(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DepartmentWithCount>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.departmentsRetrieveV1(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async departmentsRetrieveV2(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DepartmentWithCoursesAndPrograms>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.departmentsRetrieveV2(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["DepartmentsApi.departmentsRetrieveV2"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const DepartmentsApiFactory = function (
  ...
  return {
    ...
    departmentsRetrieveV1(
      requestParameters: DepartmentsApiDepartmentsRetrieveV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<DepartmentWithCount> {
      return localVarFp
        .departmentsRetrieveV1(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get department details - v2
    ...
    departmentsRetrieveV2(
      requestParameters: DepartmentsApiDepartmentsRetrieveV2Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<DepartmentWithCoursesAndPrograms> {
      return localVarFp
        .departmentsRetrieveV2(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export const EnrollmentsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    enrollmentsDestroy: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("enrollmentsDestroy", "id", id)
      const localVarPath = `/api/v1/enrollments/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    enrollmentsPartialUpdate: async (
      id: number,
     ...
     * @throws {RequiredError}
     */
    userEnrollmentsDestroyV2: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("userEnrollmentsDestroyV2", "id", id)
      const localVarPath = `/api/v2/enrollments/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const EnrollmentsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEnrollmentsCreate(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.apiEnrollmentsCreate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async enrollmentsCreate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CourseRunEnrollment>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.enrollmentsCreate(
          CourseRunEnrollmentRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.enrollmentsCreate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.enrollmentsDestroy(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.enrollmentsDestroy"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async enrollmentsList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<CourseRunEnrollment>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.enrollmentsList(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.enrollmentsList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async enrollmentsPartialUpdate(
      id: number,
      PatchedUpdateCourseRunEnrollmentRequest?: PatchedUpdateCourseRunEnrollmentRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.enrollmentsPartialUpdate(
          id,
          PatchedUpdateCourseRunEnrollmentRequest,
          options,
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.enrollmentsUpdate(
          id,
          CourseRunEnrollmentRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.enrollmentsUpdate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async userEnrollmentsCreateV2(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CourseRunEnrollmentRequestV2>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userEnrollmentsCreateV2(
          CourseRunEnrollmentRequestV2Request,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.userEnrollmentsCreateV2"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async userEnrollmentsDestroyV2(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userEnrollmentsDestroyV2(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.userEnrollmentsDestroyV2"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async userEnrollmentsListV2(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<CourseRunEnrollmentRequestV2>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userEnrollmentsListV2(
          exclude_b2b,
          org_id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["EnrollmentsApi.userEnrollmentsListV2"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const EnrollmentsApiFactory = function (
  ...
  return {
     ...
     */
    enrollmentsCreate(
      requestParameters: EnrollmentsApiEnrollmentsCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CourseRunEnrollment> {
      return localVarFp
        .enrollmentsCreate(
          requestParameters.CourseRunEnrollmentRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
     ...
     */
    enrollmentsDestroy(
      requestParameters: EnrollmentsApiEnrollmentsDestroyRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .enrollmentsDestroy(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * API view set for user enrollments
    ...
    enrollmentsPartialUpdate(
      ...
      return localVarFp
        .enrollmentsPartialUpdate(
          requestParameters.id,
          requestParameters.PatchedUpdateCourseRunEnrollmentRequest,
          options,
        )
        .then((request) => request(axios, basePath))
    },
     ...
     */
    enrollmentsUpdate(
      requestParameters: EnrollmentsApiEnrollmentsUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CourseRunEnrollment> {
      return localVarFp
        .enrollmentsUpdate(
     ...
     */
    userEnrollmentsCreateV2(
      requestParameters: EnrollmentsApiUserEnrollmentsCreateV2Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CourseRunEnrollmentRequestV2> {
      return localVarFp
        .userEnrollmentsCreateV2(
          requestParameters.CourseRunEnrollmentRequestV2Request,
          options,
        )
        .then((request) => request(axios, basePath))
    },
    ...
    userEnrollmentsDestroyV2(
      requestParameters: EnrollmentsApiUserEnrollmentsDestroyV2Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .userEnrollmentsDestroyV2(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * List user enrollments with B2B organization and contract information - API v2. Use ?exclude_b2b=true to filter out enrollments linked to course runs with B2B contracts. Use ?org_id=<id> to filter enrollments by specific B2B organization.
    ...
    userEnrollmentsListV2(
      requestParameters: EnrollmentsApiUserEnrollmentsListV2Request = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<Array<CourseRunEnrollmentRequestV2>> {
      return localVarFp
        .userEnrollmentsListV2(
          requestParameters.exclude_b2b,
          requestParameters.org_id,
          options,
        )
        .then((request) => request(axios, basePath))
...
export class EnrollmentsApi extends BaseAPI {
  ...
  public enrollmentsCreate(
    ...
    return EnrollmentsApiFp(this.configuration)
      .enrollmentsCreate(requestParameters.CourseRunEnrollmentRequest, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof EnrollmentsApi
   */
  public userEnrollmentsCreateV2(
    requestParameters: EnrollmentsApiUserEnrollmentsCreateV2Request,
    options?: RawAxiosRequestConfig,
  ) {
    return EnrollmentsApiFp(this.configuration)
   ...
   * @memberof EnrollmentsApi
   */
  public userEnrollmentsDestroyV2(
    requestParameters: EnrollmentsApiUserEnrollmentsDestroyV2Request,
    options?: RawAxiosRequestConfig,
  ) {
    return EnrollmentsApiFp(this.configuration)
...
export const PagesApiAxiosParamCreator = function (
  ...
  return {
    ...
    pagesRetrieve: async (
      ...
      const localVarPath = `/api/v2/pages/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    pagesfieldstypecmsCertificatePageRetrieve: async (
      readable_id?: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    pagesfieldstypecmsCoursePageRetrieve: async (
      readable_id?: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    pagesfieldstypecmsProgramPageRetrieve: async (
      readable_id?: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const PagesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async pagesList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageList>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.pagesList(
        fields,
        type,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["PagesApi.pagesList"]?.[localVarOperationServerIndex]
          ?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async pagesRetrieve(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PagesRetrieve200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.pagesRetrieve(
        id,
        revision_id,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["PagesApi.pagesRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async pagesfieldstypecmsCertificatePageRetrieve(
      readable_id?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CertificatePageList>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.pagesfieldstypecmsCertificatePageRetrieve(
          readable_id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          "PagesApi.pagesfieldstypecmsCertificatePageRetrieve"
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async pagesfieldstypecmsCoursePageRetrieve(
      readable_id?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursePageList>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.pagesfieldstypecmsCoursePageRetrieve(
          readable_id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["PagesApi.pagesfieldstypecmsCoursePageRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async pagesfieldstypecmsProgramPageRetrieve(
      readable_id?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ProgramPageList>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.pagesfieldstypecmsProgramPageRetrieve(
          readable_id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["PagesApi.pagesfieldstypecmsProgramPageRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const PagesApiFactory = function (
  ...
  return {
     ...
     */
    pagesList(
      requestParameters: PagesApiPagesListRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PageList> {
      return localVarFp
        .pagesList(requestParameters.fields, requestParameters.type, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns details of a specific Wagtail page by ID
     ...
     */
    pagesRetrieve(
      requestParameters: PagesApiPagesRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PagesRetrieve200Response> {
      return localVarFp
        .pagesRetrieve(
          requestParameters.id,
          requestParameters.revision_id,
          options,
        )
        .then((request) => request(axios, basePath))
    },
     ...
     * Returns pages of type cms.CertificatePage
     * @summary List all Certificate Pages
     * @param {PagesApiPagesfieldstypecmsCertificatePageRetrieveRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    pagesfieldstypecmsCertificatePageRetrieve(
      requestParameters: PagesApiPagesfieldstypecmsCertificatePageRetrieveRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CertificatePageList> {
      return localVarFp
        .pagesfieldstypecmsCertificatePageRetrieve(
    ...
    pagesfieldstypecmsCoursePageRetrieve(
      requestParameters: PagesApiPagesfieldstypecmsCoursePageRetrieveRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CoursePageList> {
      return localVarFp
        .pagesfieldstypecmsCoursePageRetrieve(
          requestParameters.readable_id,
          options,
    ...
    pagesfieldstypecmsProgramPageRetrieve(
      requestParameters: PagesApiPagesfieldstypecmsProgramPageRetrieveRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProgramPageList> {
      return localVarFp
        .pagesfieldstypecmsProgramPageRetrieve(
...
/**
 * Request parameters for pagesfieldstypecmsCertificatePageRetrieve operation in PagesApi.
 * @export
 * @interface PagesApiPagesfieldstypecmsCertificatePageRetrieveRequest
 */
export interface PagesApiPagesfieldstypecmsCertificatePageRetrieveRequest {
  /**
   * filter by course readable_id
   * @type {string}
   * @memberof PagesApiPagesfieldstypecmsCertificatePageRetrieve
   */
  readonly readable_id?: string
}
...
export class PagesApi extends BaseAPI {
   ...
   * @memberof PagesApi
   */
  public pagesfieldstypecmsCertificatePageRetrieve(
    requestParameters: PagesApiPagesfieldstypecmsCertificatePageRetrieveRequest = {},
    options?: RawAxiosRequestConfig,
  ) {
    return PagesApiFp(this.configuration)
   ...
   * @memberof PagesApi
   */
  public pagesfieldstypecmsCoursePageRetrieve(
    requestParameters: PagesApiPagesfieldstypecmsCoursePageRetrieveRequest = {},
    options?: RawAxiosRequestConfig,
  ) {
    return PagesApiFp(this.configuration)
   ...
   * @memberof PagesApi
   */
  public pagesfieldstypecmsProgramPageRetrieve(
    requestParameters: PagesApiPagesfieldstypecmsProgramPageRetrieveRequest = {},
    options?: RawAxiosRequestConfig,
  ) {
    return PagesApiFp(this.configuration)
...
export const ProgramCertificatesApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    programCertificatesRetrieve: async (
      cert_uuid: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'cert_uuid' is not null or undefined
      assertParamExists("programCertificatesRetrieve", "cert_uuid", cert_uuid)
      const localVarPath = `/api/v2/program_certificates/{cert_uuid}/`.replace(
        `{${"cert_uuid"}}`,
        encodeURIComponent(String(cert_uuid)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProgramCertificatesApiFp = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async programCertificatesRetrieve(
      cert_uuid: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<V2ProgramCertificate>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programCertificatesRetrieve(
          cert_uuid,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          "ProgramCertificatesApi.programCertificatesRetrieve"
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const ProgramCertificatesApiFactory = function (
  ...
  return {
    ...
    programCertificatesRetrieve(
      requestParameters: ProgramCertificatesApiProgramCertificatesRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V2ProgramCertificate> {
      return localVarFp
        .programCertificatesRetrieve(requestParameters.cert_uuid, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ProgramCertificatesApi extends BaseAPI {
   ...
   */
  public programCertificatesRetrieve(
    requestParameters: ProgramCertificatesApiProgramCertificatesRetrieveRequest,
    options?: RawAxiosRequestConfig,
  ) {
 ...
 * @export
 */
export const ProgramCollectionsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    programCollectionsRetrieve: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("programCollectionsRetrieve", "id", id)
      const localVarPath = `/api/v2/program-collections/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
 ...
 * @export
 */
export const ProgramCollectionsApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    ProgramCollectionsApiAxiosParamCreator(configuration)
  return {
    /**
     * Readonly viewset for ProgramCollection objects.
     * @param {number} [page] A page number within the paginated result set.
    ...
    async programCollectionsList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedV2ProgramCollectionList>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programCollectionsList(
          page,
          page_size,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProgramCollectionsApi.programCollectionsList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async programCollectionsRetrieve(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<V2ProgramCollection>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programCollectionsRetrieve(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          "ProgramCollectionsApi.programCollectionsRetrieve"
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const ProgramCollectionsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    programCollectionsList(
      requestParameters: ProgramCollectionsApiProgramCollectionsListRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedV2ProgramCollectionList> {
      return localVarFp
        .programCollectionsList(
    ...
    programCollectionsRetrieve(
      requestParameters: ProgramCollectionsApiProgramCollectionsRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V2ProgramCollection> {
      return localVarFp
        .programCollectionsRetrieve(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ProgramCollectionsApi extends BaseAPI {
   ...
   */
  public programCollectionsList(
    requestParameters: ProgramCollectionsApiProgramCollectionsListRequest = {},
    options?: RawAxiosRequestConfig,
  ) {
    return ProgramCollectionsApiFp(this.configuration)
      .programCollectionsList(
        requestParameters.page,
        requestParameters.page_size,
        options,
   ...
   * @memberof ProgramCollectionsApi
   */
  public programCollectionsRetrieve(
    requestParameters: ProgramCollectionsApiProgramCollectionsRetrieveRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ProgramCollectionsApiFp(this.configuration)
 ...
 * @export
 */
export const ProgramEnrollmentsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    programEnrollmentsDestroy: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("programEnrollmentsDestroy", "id", id)
      const localVarPath = `/api/v1/program_enrollments/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    programEnrollmentsRetrieve: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
 ...
 * @export
 */
export const ProgramEnrollmentsApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    ProgramEnrollmentsApiAxiosParamCreator(configuration)
  return {
    /**
     * Unenroll the user from this program. This is simpler than the corresponding function for CourseRunEnrollments; edX doesn\'t really know what programs are so there\'s nothing to process there.
     * @param {number} id Program enrollment ID
     ...
     * @throws {RequiredError}
     */
    async programEnrollmentsDestroy(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UserProgramEnrollmentDetail>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programEnrollmentsDestroy(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProgramEnrollmentsApi.programEnrollmentsDestroy"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async programEnrollmentsList(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<UserProgramEnrollmentDetail>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programEnrollmentsList(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProgramEnrollmentsApi.programEnrollmentsList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async programEnrollmentsRetrieve(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programEnrollmentsRetrieve(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          "ProgramEnrollmentsApi.programEnrollmentsRetrieve"
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const ProgramEnrollmentsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    programEnrollmentsDestroy(
      requestParameters: ProgramEnrollmentsApiProgramEnrollmentsDestroyRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<UserProgramEnrollmentDetail> {
      return localVarFp
        .programEnrollmentsDestroy(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Returns a unified set of program and course enrollments for the current user.
    ...
    programEnrollmentsRetrieve(
      requestParameters: ProgramEnrollmentsApiProgramEnrollmentsRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<UserProgramEnrollmentDetail> {
      return localVarFp
        .programEnrollmentsRetrieve(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ProgramEnrollmentsApi extends BaseAPI {
   ...
   */
  public programEnrollmentsDestroy(
    requestParameters: ProgramEnrollmentsApiProgramEnrollmentsDestroyRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ProgramEnrollmentsApiFp(this.configuration)
      .programEnrollmentsDestroy(requestParameters.id, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ProgramEnrollmentsApi
   */
  public programEnrollmentsRetrieve(
    requestParameters: ProgramEnrollmentsApiProgramEnrollmentsRetrieveRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return ProgramEnrollmentsApiFp(this.configuration)
...
export const ProgramsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    programsRetrieveV2: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("programsRetrieveV2", "id", id)
      const localVarPath = `/api/v2/programs/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async programsListV1(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedV1ProgramList>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.programsListV1(
        id,
        live,
        page,
        page_size,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProgramsApi.programsListV1"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async programsListV2(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedV2ProgramList>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.programsListV2(
        id,
        live,
        org_id,
        page,
     ...
     * @throws {RequiredError}
     */
    async programsRetrieveV1(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Program>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programsRetrieveV1(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProgramsApi.programsRetrieveV1"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async programsRetrieveV2(
      id: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2Program>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.programsRetrieveV2(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const ProgramsApiFactory = function (
  ...
  return {
     ...
     */
    programsListV1(
      requestParameters: ProgramsApiProgramsListV1Request = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedV1ProgramList> {
      return localVarFp
        .programsListV1(
     ...
     */
    programsListV2(
      requestParameters: ProgramsApiProgramsListV2Request = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedV2ProgramList> {
      return localVarFp
        .programsListV2(
     ...
     */
    programsRetrieveV1(
      requestParameters: ProgramsApiProgramsRetrieveV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V1Program> {
      return localVarFp
        .programsRetrieveV1(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * API view set for Programs - v2
    ...
    programsRetrieveV2(
      ...
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<V2Program> {
      return localVarFp
        .programsRetrieveV2(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
 ...
 * @export
 */
export const UserSearchApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    userSearchRetrieve: async (
      id: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("userSearchRetrieve", "id", id)
      const localVarPath = `/api/v0/user_search/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const UserSearchApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    UserSearchApiAxiosParamCreator(configuration)
  return {
    /**
     * Provides an API for listing system users. This is for the staff dashboard.
     * @param {number} [l] Number of results to return per page.
    ...
    async userSearchList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedStaffDashboardUserList>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.userSearchList(
        l,
        o,
        search,
        options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["UserSearchApi.userSearchList"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async userSearchRetrieve(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<StaffDashboardUser>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userSearchRetrieve(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["UserSearchApi.userSearchRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const UserSearchApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     */
    userSearchList(
      requestParameters: UserSearchApiUserSearchListRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedStaffDashboardUserList> {
      return localVarFp
        .userSearchList(
     ...
     */
    userSearchRetrieve(
      requestParameters: UserSearchApiUserSearchRetrieveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<StaffDashboardUser> {
      return localVarFp
        .userSearchRetrieve(requestParameters.id, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class UserSearchApi extends BaseAPI {
  ...
  public userSearchList(
    ...
    return UserSearchApiFp(this.configuration)
      .userSearchList(
        requestParameters.l,
        requestParameters.o,
        requestParameters.search,
...
export const UserinfoApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async userinfoRetrieve(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userinfoRetrieve(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["UserinfoApi.userinfoRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const UsersApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    usersCurrentUserPartialUpdate: async (
     ...
     * @throws {RequiredError}
     */
    usersCurrentUserRetrieve: async (
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/v0/users/current_user/`
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    usersRetrieve: async (
      ...
      const localVarPath = `/api/v0/users/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const UsersApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async usersCurrentUserPartialUpdate(
      PatchedUserRequest?: PatchedUserRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersCurrentUserPartialUpdate(
          PatchedUserRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["UsersApi.usersCurrentUserPartialUpdate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async usersCurrentUserRetrieve(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersCurrentUserRetrieve(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["UsersApi.usersCurrentUserRetrieve"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.usersMePartialUpdate(
          PatchedUserRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["UsersApi.usersMePartialUpdate"]?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async usersRetrieve(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PublicUser>
    > {
...
export const UsersApiFactory = function (
  ...
  return {
    ...
    usersCurrentUserPartialUpdate(
      requestParameters: UsersApiUsersCurrentUserPartialUpdateRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<User> {
      return localVarFp
        .usersCurrentUserPartialUpdate(
    ...
    usersMePartialUpdate(
      requestParameters: UsersApiUsersMePartialUpdateRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<User> {
      return localVarFp
        .usersMePartialUpdate(requestParameters.PatchedUserRequest, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * User retrieve and update viewsets for the current user
...
export class UsersApi extends BaseAPI {
   ...
   * @memberof UsersApi
   */
  public usersCurrentUserPartialUpdate(
    requestParameters: UsersApiUsersCurrentUserPartialUpdateRequest = {},
    options?: RawAxiosRequestConfig,
  ) {
