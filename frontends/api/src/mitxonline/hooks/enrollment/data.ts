...
const courses = {
  started_enrollment_open: {
    run: {
      title: "course-v1:xOnline+test/",
      ...
      course: {
        ...
        page: {
          ...
          page_url: "/courses/course-v1:xOnline+test/",
          description:
  ...
  ended_no_certificate: {
    run: {
      ...
      upgrade_deadline: "2022-12-04T15:00:00Z",
      is_upgradable: false,
      is_enrollable: false,
      is_archived: false,
      is_self_paced: false,
      ...
      course: {
        ...
        page: {
          ...
          page_url: "/courses/course-v1:MITx+14.310x/",
          description:
  ...
  enrollment_started_course_not_started: {
    run: {
      title: "The Challenges of Global Poverty",
      start_date: "2030-09-12T15:00:00Z",
