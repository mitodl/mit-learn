...
def test_get_completion(mocker, debug):
    ...
    # Some weird issue with differences in `\` here, will figure it out later
    assert results == "".join([str(value) for value in expected_return_value])
